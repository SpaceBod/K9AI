...
class WatsonAssistant:
    def __init__(self, api_key, id, service_url, intents_file):
        ...
        self.intent_mapping = {
           ...
           # 'Podcast Feedback Fav': podcast_feedback("favourite")
        }
